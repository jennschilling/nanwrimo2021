...
insta_title <- ggplot() +
  annotate("text",
           x = -15,
           y = 0.5,
           label = "November is National Novel Writing Month.\nHundreds of thousands of people around the world participate.\nThe goal is to write 50,000 words during the month.\nIn 2021, I participated for the second time.\nI wrote every day during November.\nI ended the month with a total of 50,179 words\nafter 33 hours and 41 minutes of writing.",
           family = font,
           color = fontcolor,
           size = 10,
           hjust = 0)  +
  ...
  coord_cartesian(clip = "off") +
  labs(caption = "<b>Logo:</b> Image courtesy of National Novel Writing Month 
                  | <b>Data & Design:</b> Jenn Schilling | Learn more at nanowrimo.org") +
  theme(axis.text.x = element_blank())

ggsave("nanwrimo_title.png",
       plot = insta_title,
       width = 12,
       height = 12,
       type = "cairo")
...
# Bars
ggsave("nanowrimo_bars.png",
       plot = times_bar / time_day_bar + 
         plot_annotation(caption = "<b>Data & Design:</b> Jenn Schilling | Learn more at nanowrimo.org") & 
         theme(plot.caption = element_markdown(size = 8, 
                                               color = fontcolor, 
                                               hjust = 1)),
       width = 8.5,
